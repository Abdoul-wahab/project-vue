...
<div>
  ...
  <div class="py-3 sm:max-w-xl m-10 sm:mx-auto">
      ...
      <div class="flex flex-col w-1/2 space-y-4">
          ...
          <button  v-if="$auth.loggedIn" @click="showModal(artist)" class="focus:outline-none inline-flex items-center justify-center w-10 h-10 mr-2 text-gray-700 transition-colors duration-150 bg-gray-100 rounded-full hover:bg-gray-300">
